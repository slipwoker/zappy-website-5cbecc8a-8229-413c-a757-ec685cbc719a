document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if ((type === 'tel' || name.toLowerCase().includes('phone')) && !validators.phone(value)) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function () {
          ...
          const successText = contactForm.getAttribute('data-success-message') || 'Your message has been sent successfully!';
        ...
        .catch(function () {
          ...
          const errorText = contactForm.getAttribute('data-error-message') || 'Something went wrong. Please try again.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5cbecc8a-8229-413c-a757-ec685cbc719a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5cbecc8a-8229-413c-a757-ec685cbc719a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5cbecc8a-8229-413c-a757-ec685cbc719a';
